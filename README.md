...
A personal AI assistant, built as [Claude Skills](https://claude.com/docs/skills/overview).
...
**Persona lives in the skill for now.** Once there are several skills, it should move to a Project so it isn't duplicated.
...
`planning-summary-original.md` — the original planning notes, kept as background. It reflects the earlier Remote Control architecture described above and is superseded by this README.
